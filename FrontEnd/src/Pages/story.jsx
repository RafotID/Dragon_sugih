...
const Story = () => {
    ...
    const handleNext = () => {
        if (currentStep < 16) {
            ...
            navigate('/penghubung/0', { state: { mode: 'battle2' } });

        } else if (currentStep > 19 && currentStep < 22) {
            navigate(`/story/${Number(currentStep) + 1}`);

        } else if (currentStep == 22) {
            navigate('/penghubung/0', { state: { mode: 'battle3' } });

        } else if (currentStep > 22 && currentStep < 25) {
            navigate(`/story/${Number(currentStep) + 1}`);

        } else if (currentStep == 25) {
            navigate('/penghubung/0', { state: { mode: 'battle4' } });

        } else if (currentStep > 25 && currentStep < 28) {
            navigate(`/story/${Number(currentStep) + 1}`);
